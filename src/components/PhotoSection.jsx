        ...
        <section className="container">
            <div className="photo-section" id="photo-section">
                <div className="photo__container">
                    <img className="img-1" src="./image_1.jpg" alt="" />
                    <img className="img-2" src="./image_2.jpg" alt="" />
                    <img className="img-3" src="./image_11.jpg" alt="" />
                    <img className="img-4" src="./image_9.jpg" alt="" />
                    <img className="img-5" src="./image_5.jpg" alt="" />
                </div>
