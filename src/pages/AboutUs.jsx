                ...
                <div className="about-us__section">
                    ...
                    <div className="about-us__text">
                        <h2 className="about-us__title">
                            You should remember your trip to Iceland as the most
                            epic trip of your life.
                        </h2>
                        ...
                        <p className="about-us__details">
                            ...
                            voluptatum laudantium vel accusamus atque mollitia
                            illum sit alias consectetur, temporibus, ullam odit
                            eaque officiis!
                        </p>
                        <button
